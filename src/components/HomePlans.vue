                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>
                                The Keto diet is a high-fat, adequate-protein, low-carbohydrate diet. The diet forces the body to burn fats rather than
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>
                                The Paleo diet requires the sole or predominant consumption of foods presumed to have been the only foods available to or
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>
                                The vegan diet abstains from the use of animal products. The vegan diet does not consume meat, diary products, eggs or any all
...
export default {
    ...
    methods: {
        async showRecipes(plan) {
            try {
                let response = await this.$ajax.get(this.$apiUrl, {
                    params: {
                        q: plan,
                        app_id: 'b58cb519',
                        app_key: '48b666314167c63a44ff4ae429e07b2f',
                        from: 0,
                        to: 9
                    }
                });
